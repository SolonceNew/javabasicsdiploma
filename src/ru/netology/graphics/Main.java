...
import ru.netology.graphics.image.TextGraphicsConverterCl;
...
public class Main {
    public static void main(String[] args) throws Exception {
        TextGraphicsConverterCl converter = new TextGraphicsConverterCl(); // Создайте тут объект вашего класса конвертера
